...
?>
	<div id="content">
		...
		<div class="border-tab-menu paddmenus">
			...
			<form method="post">
				<?php
				if($order_temp->cJenisTerimaMakanan==1 || $order_temp->cJenisTerimaMakanan==2){
				?>
				<strong>Alamat Pengantaran</strong>
				<div class="padd7"></div>
				<div class="checkbox-row">
					<div class="checkout-address_"><input type="radio" class="radiopick" name="address" value="1" checked onclick="toggle('hide');">Terdaftar</div>
					<div class="checkout-address"><?=$user_profile->cAlamat." - ".$user_profile->cNamaWilayah?></div>								
				</div>
				<div class="padd7"></div>			
				<div class="checkbox-row">				
					<div class="checkout-address_"><input type="radio" class="radiopick" name="address" value="2" onclick="toggle('show');">Alamat Baru</div>
					<div id="test" style="display:none;">
						<div class="checkout-address">
							<?php
								$erroralamat= "";
								if (form_error('address2')){
									$erroralamat=form_error('address2');
								}
							?>
							<textarea class="checkout-input-address-text" id="address2" name="address2" placeholder="<?=$erroralamat?>"></textarea>
							<div style="margin-top:10px; width:424px;"> 
								<?php
									$errorregion= "";
				...
				<div class="padd7"></div>
				<div class="checkbox-row">
					<div class="checkout-info-add">
					<textarea class="checkout-input-address-text" name="info"></textarea>
					</div>
					<div class="checkout-address">
						<!--<input type="submit" name="btnsubmit" id="btnsubmit" value="Finish" class="btn-style">-->
					</div>
					<!--<a href="<?=$base?>/index.php/home/finish" class="btnsubmit"></a>-->
				</div>
				<div class="padd20"></div>
