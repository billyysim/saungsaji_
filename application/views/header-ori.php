...
<script type="text/javascript" >
	function sticky() {
	      ...
	      $("#header,#footer").css("left", -$(this).scrollLeft() + "px");
	      if ($(".smalllogo").length < 1 && $(window).scrollTop() > 140) {
	          $('<img class="smalllogo" src="<?=$base?>/img/logosmall.png" />').appendTo("#header").css({
	              left: e / 2 - 60 + "px"
	          }).fadeIn("slow")
	      }
...
<div id="container">
			...
			<div id="headerMenu">
				<ul class="menu">
					...
					?>
						...
						<li class="mnCarakerja"><a  href="<?=$base?>/index.php/home/carakerja" class="btn-div-style fancybox">Cara Kerja</a></li>
					<?php
					}
					else{
					?>
					...
					?>
						<li class="mnProfile">
							...
							<div id="dd" class="wrapper-dropdown-5" tabindex="1">hi, 
								<?php
	...
	<div id="headerLogo"><img style="margin-top:10px;" src="<?=$base?>/images/saungsaji.png"  alt="saung saji"/></div>