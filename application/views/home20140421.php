...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#contentRight').load("<?=$base?>/index.php/home/by_page", {'page':track_click}, function() {track_click++;}); //initial data to load
		$(".load_more").click(function(e){ //user clicks on button	
			...
			if(track_click <= total_pages) //make sure user clicks are still less than total pages
			{
				...
				$.post('<?=$base?>/index.php/home/by_page',{'page': track_click, 'idR': idR, 'idW': idW, 'idH': idH}, function(data) {			
		...
		/*------------------------------------------*/
		$('.options-list').change(function(e){ //user clicks on button			
			var idR = $('#optionsmenu1').val();			
			var idW = $('#optionsmenu3').val();			
			var idH = $('#optionsmenu4').val();			
			$.ajax({
	...
	*/	
	...
	<div id="content">
		<div id="search">
			...
			<div class="boxsearch"><form method="post"><input type="text" class="inputsearch" id="inputsearch"></form></div>
